...
const NoticeTableCheck = ({ pageLimit, setCheckId, tableData, setPageNumber, pageNumber, checkboxId }) => {
      ...
      >
        ...
        <TableBody>
          {data && data.map((data) => (
            ...
            >
              {allCheckbox === true ?
                <TableCell align="center"><input checked="checked" type="checkbox" value={data.member_order_id} ></input></TableCell>
                : <TableCell align="center"><input type="checkbox" value={data.member_order_id} onChange={(e) => checkBoxId(e.target.checked, e.target.value)}></input></TableCell>
              }

              <TableCell component="th" scope="row" align="center">
                {data.member_order_id}
              </TableCell>
              <TableCell align="center">{data.total}</TableCell>
              <TableCell align="center">{data.member_name}</TableCell>
              <TableCell align="center">{data.member_id}</TableCell>
              <TableCell align="center">{data.payment_status}</TableCell>
              <TableCell align="center">{data.payment_date !== null ? data.payment_date.substr(0, 10) : "尚未付款"}</TableCell>
...
export default NoticeTableCheck;