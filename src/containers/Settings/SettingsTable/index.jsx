...
const SettingsTable = ({ tableData, setDetailId, setDetailOpen, setList, pageLimit, setPageNumber, pageNumber }) => {
          ...
          <TableBody>
            {data && data.map((row, index) => (
              ...
              >
                ...
                <TableCell align="center">{row.user_group_name}</TableCell>
