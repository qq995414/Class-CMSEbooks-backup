    ...
    <>
      ...
      >
        ...
        >
          ...
          <StyledFlexBox>
            <Button variant="contained" onClick={() => setDetailOpen(true)}>+ 新增經銷商</Button>
          </StyledFlexBox>
        </StyledFlexBox>
        <DiscountTable setDetailOpen={setDetailEditorOpen}
          data={data} setDetailId={setDetailId} keyWord={keyWord} />
        <DealerDetail
          open={detailOpen}
