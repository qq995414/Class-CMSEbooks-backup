...
import InvoiceTableCheck from "../InvoiceTableCheck";
import { fetchRequestPaymentAccountList, fetchRequestPaymentAccountExport } from "../../../api/RequestPaymentAccount";

const InvoiceTableExport = () => {
  const ITEMS = [
    {
      text: "匯入",
      value: "import",
  ...
  useEffect(() => {
    fetchRequestPaymentAccountList({ page_number: pageNumber, page_limit: pageLimit, query_word: keyWord }).then((data) => {
      setTableData(data);
    });
  }, []);
  useEffect(() => {
  ...
  const outputExcel = () => {
    /* const payload = {
     ...
     console.log(payload)
 */
    fetchRequestPaymentAccountExport({ ids: checkboxId }).then((res) => {
  ...
  const outputPdf = () => {
    /* const payload = {
     ...
     console.log(payload)
 */
    fetchRequestPaymentAccountExport({ ids: checkboxId, type: "pdf" }).then((res) => {
...
export default InvoiceTableExport;
