...
const CreateBook = () => {
  ...
  const [EbookFileType, setEbookFileType] = useState("file");
  const [EbookTrialFileType, setEbookTrialFileType] = useState("file");
  ...
  const onCreateBook = () => {
    ...
    const payload = {
      ...
      ebookFile: model !== "PHYSICAL" && EbookFileType === "file" ? ebookFile : null,
        ...
        >
          ...
          <StyledFlexBox px={40} flexDirection="column">
            ...
            <StyledFlexBox justifyContent="flex-end" mb={46}>
              ...
              <Button
                disabled={!subject || !name || !model || !imageFile || !type || !category || !publishDate || !dealer || !about || !content}
                variant="contained"
