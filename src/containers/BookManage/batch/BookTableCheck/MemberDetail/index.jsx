...
const MemberDetailCheck = ({ open, setDetailOpen, detailId }) => {
    const handleClose = () => {
        setDetailOpen(false);
    };
    ...
    return (
        ...
        >
            ...
            </DialogContent> : <DialogContent dividers={scroll === 'paper'} sx={{ minHeight: '817px', p: '0' }}></DialogContent>}
        </Dialog>
    );
};

export default MemberDetailCheck;